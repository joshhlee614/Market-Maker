...
class ParquetWriter:
    ...
    def __init__(self, symbol: str = "btcusdt", base_path: str = "data/raw") -> None:
        ...
        self.schema = pa.schema([
            ...
            ('bids', pa.list_(pa.string())),  # Store as list of "price,quantity" strings
            ('asks', pa.list_(pa.string()))   # Store as list of "price,quantity" strings
        ])
    ...
    def _get_file_path(self, date: datetime.date) -> Path:
        ...
        """
        return self.base_path / f"{self.symbol}_{date.strftime('%Y%m%d')}.parquet"
